...
wget -q https://github.com/pkmgr/centos/raw/master/lists/default.list -O /tmp/default-packages.txt
...
if [ -d /var/www/html/sysinfo ]; then cd /var/www/html/sysinfo && git pull -q && cd ~; else git clone https://github.com/phpsysinfo/phpsysinfo /var/www/html/sysinfo; fi
...
sleep 10
history -c && history -w && /root/bin/clean.sh
